...
const chapters = [
  ['00-icebreaker.md',         ['How *not* to do Feature Flags', 'What happened', 'Fun with Flags', 'Who am I?', 'A quick thank-you', 'Agenda']],
  ...
  ['03-iceberg.md',            ['Feature Flagging is an Iceberg', 'The Feature-Flagging Iceberg', 'At the start, you see…', 'Later you discover…']],
  ...
  ['07-take-aways-and-cta.md', ['Take-aways', 'What we covered', "What we didn't cover", 'Join us', "You're in good company",
                                'Try it out', 'Thanks — Q&A', 'Left of the Loop']],
